...
public class TrainMethodReturnRunner {
    public static void main(String[] args) {
        ...
        System.out.println(("метод returnNewFloat вернул" + returnValue.returnNewFloat(10.66)));
        System.out.println(("метод returnNewDouble вернул" + returnValue.returnNewFloat(10.88)));
